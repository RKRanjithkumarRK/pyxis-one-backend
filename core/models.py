...
class Session(Base):
    ...
    psyche_states: Mapped[list["PsycheState"]] = relationship("PsycheState", back_populates="session", cascade="all, delete-orphan")
    forge_progress: Mapped[list["ForgeProgress"]] = relationship("ForgeProgress", back_populates="session", cascade="all, delete-orphan")
    concept_masteries: Mapped[list["ConceptMastery"]] = relationship("ConceptMastery", back_populates="session", cascade="all, delete-orphan")
    vault_entries: Mapped[list["VaultEntry"]] = relationship("VaultEntry", back_populates="session", cascade="all, delete-orphan")
    blind_spots: Mapped[list["BlindSpot"]] = relationship("BlindSpot", back_populates="session", cascade="all, delete-orphan")
    oracle_timelines: Mapped[list["OracleTimeline"]] = relationship("OracleTimeline", back_populates="session", cascade="all, delete-orphan")
    civilization_states: Mapped[list["CivilizationState"]] = relationship("CivilizationState", back_populates="session", cascade="all, delete-orphan")
    mirror_reports: Mapped[list["MirrorReport"]] = relationship("MirrorReport", back_populates="session", cascade="all, delete-orphan")
    nemesis_records: Mapped[list["NemesisRecord"]] = relationship("NemesisRecord", back_populates="session", cascade="all, delete-orphan")
    helix_revolutions: Mapped[list["HelixRevolution"]] = relationship("HelixRevolution", back_populates="session", cascade="all, delete-orphan")
    tide_readings: Mapped[list["TideReading"]] = relationship("TideReading", back_populates="session", cascade="all, delete-orphan")
